...
public class MerchantSignup extends HttpServlet{
	public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException{
		...
		//	String phone = merchantSignupJson.phone;
			...
			String password=merchantSignupJson.password;
		...
		//	LocalDate dob = LocalDate.parse(merchantSignupJson.dob);
			...
			if(affted>0){
				out.print("{\"status\":\"success\",\"flag\":\"1\",\"password\":\""+merchantSignupJson.password+"\"}");
			}
		}
...
class MerchantSignupJson{
	String name,dob,gender,email,type,country,state,district,city,address,password;
	String phone;
	public MerchantSignupJson(){}
...
public	String getPhone(){
 ...
 public String toString(){
 	return "MerchantSignupJson [name:"+name+",gender:"
 			+gender+",email:"
 			+email+",phone:"+phone+",type:"
 			+type+",country:"+country+",state:"
 			+state+",district:"+district+",city:"
 			+city+",address:"+address+",dob:"
